...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/model_probe", permission: authz.ChannelRead, handler: controller.GetModelProbe},
	{method: http.MethodPost, path: "/model_officiality_probe/:id", permission: authz.ChannelOperate, handler: controller.ProbeModelOfficiality},
	{method: http.MethodPost, path: "/purity/scans", permission: authz.ChannelOperate, handler: controller.StartChannelPurityScan},
	{method: http.MethodPost, path: "/purity/groups", permission: authz.ChannelWrite, handler: controller.CreateChannelPurityGroup},
	{method: http.MethodGet, path: "/purity/groups", permission: authz.ChannelRead, handler: controller.ListChannelPurityGroups},
	...
	{method: http.MethodGet, path: "/purity/groups/:group_id/run/:task_id", permission: authz.ChannelRead, handler: controller.GetChannelPurityGroupDetectionTask},
	...
	{method: http.MethodGet, path: "/purity/history", permission: authz.ChannelRead, handler: controller.ListAllChannelPurityHistory},
	...
	{method: http.MethodGet, path: "/purity/groups/:group_id/history/preview", permission: authz.ChannelRead, handler: controller.GetChannelPurityHistoryPreview},
	{method: http.MethodDelete, path: "/purity/groups/:group_id/history", permission: authz.ChannelSensitiveWrite, handler: controller.ClearChannelPurityHistory},
	{method: http.MethodPost, path: "/purity/groups/:group_id/alerts/:alert_id/actions", permission: authz.ChannelOperate, handler: controller.UpdateChannelPurityIncident},
	{method: http.MethodPost, path: "/purity/inspections", permission: authz.ChannelOperate, handler: controller.StartChannelPurityInspection},
	{method: http.MethodGet, path: "/purity/inspection/status", permission: authz.ChannelRead, handler: controller.GetChannelPurityInspectionStatus},
	{method: http.MethodGet, path: "/purity/inspection/settings", permission: authz.ChannelRead, handler: controller.GetChannelPurityInspectionSettings},
	{method: http.MethodPut, path: "/purity/inspection/settings", permission: authz.ChannelOperate, handler: controller.UpdateChannelPurityInspectionSettings},
	{method: http.MethodGet, path: "/purity/results", permission: authz.ChannelRead, handler: controller.ListChannelPurityResults},
	{method: http.MethodGet, path: "/purity/scans/:scan_id", permission: authz.ChannelRead, handler: controller.GetChannelPurityScan},
	{method: http.MethodGet, path: "/:id/purity/latest", permission: authz.ChannelRead, handler: controller.GetLatestChannelPurityResult},
